...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    i,score,pig_out=1,0,0
    while i<=num_rolls:
        die=dice()
        if die ==1 :
            pig_out=1 
        score,i=score+die,i+1
    if pig_out==1:
         return 1
    return score
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    last_turn0,last_turn1=0,0
    while score0 <goal and score1 <goal:
        if who==0:
            num_roll= strategy0(score0,score1) 
            this_turn0=take_turn(num_roll,score1,dice)
            score0=score0+this_turn0
            if feral_hogs and abs(last_turn0-num_roll)==2:
                score0=score0+3
            last_turn0=this_turn0
            if is_swap(score0,score1):
                score0,score1=score1,score0
        else:
            num_roll= strategy1(score1,score0)
            this_turn1=take_turn(num_roll,score0,dice)
            score1=score1+this_turn1
            if feral_hogs and abs(last_turn1-num_roll)==2:
                score1=score1+3
            last_turn1=this_turn1
