...
def closer_city(lat, lon, city_a, city_b):
    ...
    >>> stanford = make_city('Stanford', 35.05, 118.25)
    ...
    """
    "*** YOUR CODE HERE ***"
    ref=make_city('reference',lat,lon)
    dis={distance(ref,city_a):city_a,distance(ref,city_b):city_b}
    return get_name(dis[min(dis.keys())])
